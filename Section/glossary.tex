...
\begin{description}
	\item[BSS] Base Station Subsystem
	\item[BSSGP] BSS GPRS Application Protocol
	\item[DL] Downlink
	\item[GGSN] Gateway GPRS Support Node
	\item[GR] GPRS Register
	\item[GSN] GPRS Support Node
	\item[GTP] GPRS Tunneling Protocol
	\item[LLC] Logical Link Control
	\item[MAC] Medium Access Control
	\item[MM] Mobility Management
	\item[PACCH] Packet Associated Control Channel
	\item[PAGCH] Packet Access Grant Channel 
	\item[PBCCH] Packet Broadcast Control Channel
	\item[PCU] Package Control Unit
	\item[PDP] Packet Data Protocol
	\item[PDTCH] Packet Data Traffic Channel
	\item[PNCH] Packet Notifiaction Channel
	\item[PPCH] Packet Paging Channel
	\item[PTCCH] Packet Timing Advance Control Channel
	\item[P-TMSI] Packet Temporary Mobile Subscriber Identity
	\item[PRACH] Packet Random Access Channel
	\item[RA] Routing Area
...
\begin{description}
	\item[BCH] Broadcast Control Channel
	\item[CCCH] Common Control Channel
	\item[CN] Core Network
	\item[CPC] Continous Packet Connectivity 
	\item[CSD] Circuit Switched Domain
	\item[CTCH] Common Traffic Channel
	\item[DCCH] Dedicated Control Channel
	\item[DCH] Dedicated Channel
	\item[DPCCH] Dedicated Physical Control Channel
	\item[DPDCH] Dedicated Physical Data Channel
	\item[DSCH] Downlink Shared Channel
	\item[DTCH] Dedicated Traffic Channel
	\item[FACH] Forward Access Control Channel
	\item[FDD] Frequency Division Duplex
	\item[GGSN] Gateway GPRS Support Node
	\item[GMSC] Gateway Mobile Switching Center
	\item[HLR] Home Location Register
	\item[HSDPA] High Speed Downlink Packet Access
	\item[HSUPA] High Speed Uplink Packet Access
	\item[HSPA] High Speed Packet Access
	\item[HSPA+] High Speed Packet Access Plus
	\item[IuCS] Interface CSD
	\item[IuPS] Interface PSD
	\item[LTE] Long Term Envolution
	\item[MAC] Medium Access Control
	\item[MIMO] Multiple Input Multiple Output 
	\item[MSC] Mobile Switching Center
	\item[Node-B] Basisstation (vergleichbar zur BTS im GSM)
	\item[PCCH] Paging Control Channel
	\item[PCCPCH] Primary common control physical Channel
	\item[PCH] Paging Channel
	\item[PCPCH] Phyiscal common packet channel
	\item[PDSCH] Physical downlink shared channel
